...
<script type="text/javascript">
    function sendId2(client_id) {
        document.getElementById('modal-footer').innerHTML = "<a href=\"<?php echo base_url('clients/setClientActive?client_id=') ?>" + client_id + "\" class=\"btn btn-primary\">Si</a><a class=\"btn\" data-dismiss=\"modal\">No</a>"
