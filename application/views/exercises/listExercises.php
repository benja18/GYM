...
<script type="text/javascript">
    function sendId(exercise_id){                
        document.getElementById('modal-footer').innerHTML = "<a href=\"<?php echo base_url('exercises/delete?exercise_id=')?>"+exercise_id+"\" class=\"btn btn-primary\">Si</a><a class=\"btn\" data-dismiss=\"modal\">No</a>"
        ...
        <tbody>
            <?php if (isset($data['exercises'])) {
                foreach ($data['exercises'] as $exercise) {
                    ?>
                    <tr>                        
                        <td><strong><?php echo $exercise->name ?></strong></td>
                        <td><strong><?php echo $exercise->muscle_name ?></strong></td>
                        <td>
                            <a class="btn btn-primary btn-mini" href="<?php echo base_url('exercises/update?exercise_id=').$exercise->exercise_id ?>"><i class="icon-edit  icon-white"></i> Editar</a>
