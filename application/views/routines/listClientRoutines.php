...
<script type="text/javascript">
    function sendId(routine_id){                
        document.getElementById('modal-footer').innerHTML = "<a href=\"<?php echo base_url('routines/delete?routine_id=')?>"+routine_id+"&client_id=<?php echo $_GET['client_id']?>\" class=\"btn btn-primary\">Si</a><a class=\"btn\" data-dismiss=\"modal\">No</a>"
...
<div class="row span12 offset2">
    <?php if ($data['status'] == 'CantDelete') { ?>
        <div class="alert alert-block alert-error fade in">
            ...
            <p>No se puede eliminar la rutina ya que tiene ejercicios asociados.</p>
        </div>
    <?php } ?>
...
<div class="modal hide" id="modal-delete">
    ...
    <div class="modal-body">
        <p>¿Está seguro que desea eliminar la rutina?</p>
    </div>
